    ...
    public class JobsMongoDbService:IJobService
    {
        public List<JobResponseModel> GetAllJobs()
        {
            ...
            var jobs = new List<JobResponseModel>() {
                new JobResponseModel{Id = 1, Title = "C# Developer", Description = "Need to Know SQL and C#"},
                new JobResponseModel{Id = 2, Title = "Software Developer", Description = "Need to Know C#"},
